# صندوق ZSSA التكافلي - واجهة المستخدم (Client)

هذا هو المستودع الخاص بواجهة المستخدم (Frontend) لمنصة **صندوق ZSSA التكافلي الإجتماعي**. هذه الواجهة توفر تجربة مستخدم عصرية وسريعة لإدارة المهام الخيرية، ومتابعة الطلاب، والسجلات المالية بشفافية واحترافية عالية.
